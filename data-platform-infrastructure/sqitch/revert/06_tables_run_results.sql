...
DROP INDEX IF EXISTS :meta_schema.run_result_node_idx;
DROP INDEX IF EXISTS :meta_schema.run_result_edge_idx;
DROP INDEX IF EXISTS :meta_schema.run_result_cable_idx;
DROP INDEX IF EXISTS :meta_schema.run_result_meter_idx;
