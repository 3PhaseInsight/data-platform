...
-- Views first
DROP VIEW IF EXISTS lv.edge_current_with_totals;
DROP VIEW IF EXISTS lv.edge_with_totals;
DROP VIEW IF EXISTS lv.edge_current;
DROP VIEW IF EXISTS lv.node_current;

-- Index on version "current" flag
DROP INDEX IF EXISTS lv_topology_version_current_uniq;

-- Mapping and physical cables
DROP TABLE IF EXISTS lv.edge_cable CASCADE;
...
DROP TABLE IF EXISTS lv.edge CASCADE;
...
DROP TABLE IF EXISTS lv.node CASCADE;
...
DROP TABLE IF EXISTS lv.feeder CASCADE;
